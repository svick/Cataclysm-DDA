...
class effects_window : public player_window
{
    ...
    public:
        ...
        effects_window( const player &player, const effects_map &effects_map ) : player_window( player,
                    _( "EFFECTS" ) ) {
...
class speed_window : public player_window
{
    ...
    public:
        ...
        speed_window( const player &player, const effects_map &effects_map ) : player_window( player,
                    _( "SPEED" ) ) {
